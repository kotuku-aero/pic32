...
{
	int b;
	int32 *coeffs32 = (int32 *) coeffs;

	for (b = 0; b < B; b += 2)
	{
		coeffs32[2*b+0] = (bq[b].a1 << 16) | (bq[b+1].a1 & 0xFFFF);
		coeffs32[2*b+1] = (bq[b].a2 << 16) | (bq[b+1].a2 & 0xFFFF);
		coeffs32[2*b+2] = (bq[b].b1 << 16) | (bq[b+1].b1 & 0xFFFF);
		coeffs32[2*b+3] = (bq[b].b2 << 16) | (bq[b+1].b2 & 0xFFFF);
	}
}
