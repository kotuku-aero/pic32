...
/*********************************************************************
 * Function:        short int* VectorMultiply16 ( int numElems,short int* dstV,short int* srcV1,short int* srcV2)
 *
 * PreCondition:    None
 *
 ...
 * Note:            None
 ********************************************************************/
short int* VectorMultiply16 ( int numElems,short int* dstV,short int* srcV1,short int* srcV2)
{
    mips_vec_mul16(dstV, srcV1, srcV2, numElems);
