...
/*********************************************************************
 * Function:        int VectorDotProduct32 ( int numElems,int* srcV1,int* srcV2)
 *
 * PreCondition:    None
 *
 ...
 * Note:            None
 ********************************************************************/
int VectorDotProduct32 ( int numElems,int* srcV1,int* srcV2)
{
    return(mips_vec_dotp32(srcV1, srcV2, numElems, 0));
}
