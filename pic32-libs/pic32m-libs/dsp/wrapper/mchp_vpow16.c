...
/*********************************************************************
 * Function:        short int VectorPower16 (int numElems,short int* srcV)
 *
 * PreCondition:    None
 *
...
short int VectorPower16 (int numElems,short int* srcV)
{
    return(mips_vec_sum_squares16(srcV, numElems, 0));
}
