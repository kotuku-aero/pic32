...
/*********************************************************************
 * Function:        int* VectorMultiply32 ( int numElems,int* dstV,int* srcV1,int* srcV2)
 *
 * PreCondition:    None
 *
 ...
 * Note:            None
 ********************************************************************/
int* VectorMultiply32 ( int numElems,int* dstV,int* srcV1,int* srcV2)
{
    mips_vec_mul32(dstV, srcV1, srcV2, numElems);
