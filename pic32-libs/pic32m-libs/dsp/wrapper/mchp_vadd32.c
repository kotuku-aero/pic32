...
/*********************************************************************
 * Function:        int* VectorAdd32(int numElems,int* dstV,int* srcV1,int* srcV2)
 *
 * PreCondition:    None
 *
 ...
 * Note:            None
 ********************************************************************/
int* VectorAdd32(int numElems,int* dstV,int* srcV1,int* srcV2)
{
    mips_vec_add32(dstV, srcV1, srcV2, numElems);
