...
elseif(EXISTS "${CMAKE_SOURCE_DIR}/dfp/PIC32MZ-DA")
    set(DFP_PATH "${CMAKE_SOURCE_DIR}/dfp/PIC32MZ-DA")
...
set(CMAKE_C_FLAGS_INIT "${PIC32_CPU_FLAGS} -I${TOOLCHAIN_PATH}/atom ${PIC32_DFP_FLAGS} ${PIC32_WARN_FLAGS}")
...
# C++ Flags - include DFP path for xc.h and device headers
set(CMAKE_CXX_FLAGS_INIT "${PIC32_CPU_FLAGS} -I${TOOLCHAIN_PATH}/atom ${PIC32_DFP_FLAGS} ${PIC32_WARN_FLAGS} -fno-exceptions -fno-rtti")
