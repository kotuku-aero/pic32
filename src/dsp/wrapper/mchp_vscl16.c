...
/*********************************************************************
 * Function:        short int* VectorScale16 (int numElems,short int* dstV,short int* srcV,short int sclVal)
 *
 * PreCondition:    None
 *
 ...
 * Note:            None
 ********************************************************************/
short int* VectorScale16 (int numElems,short int* dstV,short int* srcV,short int sclVal)
{
    mips_vec_mulc16(dstV, srcV, sclVal, numElems);
