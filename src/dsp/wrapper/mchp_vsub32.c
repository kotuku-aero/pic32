...
/*********************************************************************
 * Function:        int* VectorSubtract32 (int numElems,int* dstV,int* srcV1,int* srcV2)
 *
 * PreCondition:    None
 *
...
int* VectorSubtract32 (int numElems,int* dstV,int* srcV1,int* srcV2)
{
    mips_vec_sub32(dstV, srcV1, srcV2, numElems);
