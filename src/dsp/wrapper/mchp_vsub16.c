...
/*********************************************************************
 * Function:        short int* VectorSubtract16 (int numElems,short int* dstV,short int* srcV1,short int* srcV2)
 *
 * PreCondition:    None
 *
...
short int* VectorSubtract16 (int numElems,short int* dstV,short int* srcV1,short int* srcV2)
{
    mips_vec_sub16(dstV, srcV1, srcV2, numElems);
